...
2. **Pins de ponto**, circulares, 38–48 px, contorno branco de 3 px e sombra suave:
   - verde `#3E8F5E` com ícone de confirmação — ok hoje
   - caramelo `#B9702F` com ícone de pata — precisa hoje
   - vermelho `#C1452F` com ícone de atenção — urgente
   - cinza `#A08F7C` — ponto órfão (sobrepõe a cor de status)
...
**Cor no pin, não ícone diferente por status.** A leitura precisa acontecer de relance, com o celular a meio braço, no sol. Cor resolve isso; forma diferente por status exigiria aprender uma legenda.
...
| Status | Condição | Cor |
|---|---|---|
| Ok hoje | último registro há menos de 4 h | verde `#3E8F5E` |
| Precisa hoje | entre 4 h e 12 h | caramelo `#B9702F` |
| Urgente | mais de 12 h, ou nenhum registro | vermelho `#C1452F` |
| Sem mantenedor | ponto órfão (sobrepõe) | cinza `#A08F7C` |
