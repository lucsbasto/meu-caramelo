...
Todos os pins usam a **mesma patinha branca** no centro. O pin codifica duas coisas ao mesmo tempo:

**Preenchimento — comida**

| Status | Tempo desde o último registro | Cor |
|---|---|---|
| Cheio | < 4 h | verde `#3E8F5E` |
| Precisa hoje | 4–12 h | âmbar `#E0A93A` |
| Vazio | > 12 h | vermelho `#C1452F` |

**Borda — responsabilidade**

| Situação | Anel |
|---|---|
| Tem mantenedor | caramelo `#B9702F`, 3 px |
| Sem dono | branco, 3 px |

O filtro "Precisa hoje" cobre âmbar + vermelho. SVGs prontos em `assets/mapa/`.
